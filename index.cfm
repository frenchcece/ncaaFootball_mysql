...
<body>
	...
	<cfif IsDefined("variables.loginFailure") AND variables.loginFailure EQ "true">
      ...
      <cfif session.isLoggedIn>
		...
		<cfinvoke component="cfc.footballDao" method="selectUserPicksByWeekNumber" returnvariable="variables.qryGetUserPicksOfTheWeek">
	      ...
	      <div class="row">
	        ...
	        <div class="span4">
	          <h2>My Season</h2>
				...
				<cfinvoke component="cfc.footballDao" method="getProcessedResults" returnvariable="variables.resultsStructThisWeek">
					<cfinvokeargument name="userID" value="#session.user.userID#">
					<cfinvokeargument name="weekNumber" value="#session.currentWeekNumber#">
				</cfinvoke>
	         	<p>
				...
				<cfinvoke component="cfc.footballDao" method="getProcessedResults" returnvariable="variables.resultsStructLastWeek">
					<cfinvokeargument name="userID" value="#session.user.userID#">
				...
				<cfinvoke component="cfc.footballDao" method="getProcessedResults" returnvariable="variables.resultsStructOverall">
					<cfinvokeargument name="userID" value="#session.user.userID#">
	        ...
	        <div class="span4">
	          <h2>My Standings</h2>
				<!--- get the results of the current week for the user --->
				<cfinvoke component="cfc.footballDao" method="getStandings" returnvariable="variables.standingsThisWeek">
					<cfinvokeargument name="userID" value="#session.user.userID#">
					<cfinvokeargument name="weekNumber" value="#session.currentWeekNumber#">
				</cfinvoke>
	         	<p>
				...
				<cfif (session.currentWeekNumber-1) GT 0>
				<!--- get the results of the last week for the user --->
				<cfinvoke component="cfc.footballDao" method="getStandings" returnvariable="variables.standingsLastWeek">
					<cfinvokeargument name="userID" value="#session.user.userID#">
					<cfinvokeargument name="weekNumber" value="#session.currentWeekNumber#-1">
				</cfinvoke>
				<p>
				...
				<span class="span1">Overall:</span>
				<!--- get the overall results for the user --->
				<cfinvoke component="cfc.footballDao" method="getStandings" returnvariable="variables.standingsOverall">
					<cfinvokeargument name="userID" value="#session.user.userID#">
					<cfinvokeargument name="weekNumber" value="-1">
				</cfinvoke>
